...
- [dajneem23/gensyn-telegrambot](https://github.com/dajneem23/gensyn-telegrambot) - This is a Telegram bot that runs on Cloudflare Workers and provides the status of a Gensyn peer. (3 days ago)
- [OpenZeppelin/openzeppelin-monitor](https://github.com/OpenZeppelin/openzeppelin-monitor) - A blockchain monitoring service that watches for specific on-chain activities and triggers notifications based on configurable conditions. (1 week ago)
...
- [dajneem23/isolation-level-poc](https://github.com/dajneem23/isolation-level-poc) (1 month ago)
